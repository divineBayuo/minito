...
mixin _$AppUser {
 ...
 String get id; String get email; String? get displayName; String? get photoUrl;// UTC timestamp of account creation
...
class _AppUser implements AppUser {
  const _AppUser({required this.id, required this.email, this.displayName, this.photoUrl, required this.createdAt});
